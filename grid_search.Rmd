...
knitr::opts_chunk$set(message = FALSE,warnings=FALSE, code_folding=TRUE, cache = TRUE,dpi=800)
dels<-ls()
rm(list=dels)
...
final_results<-final[["full"]]
final_resultsCE<-final[["CE"]]
```

```{r full, fig.cap="Full period grid search results", layout="l-screen-inset"}
...
```{r CE,fig.cap="Credit Easing period grid search results",layout="l-screen-inset"}
